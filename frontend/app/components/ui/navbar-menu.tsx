...
export const Menu = ({
  ...
  return (
    ...
    <nav
      ...
      className="relative shadow-md text-xl hover:text-yellow-500 gap-10 text-black font-semibold dark:border-white/[0.2] h-[80px] bg-white shadow-input flex justify-betwdeen space-x-4 px-8 py-6 "
    >
      {children} 
    </nav> 
      </div>
